...
public class SustainabilitySquare extends StreetSquare{
	// Set prices
	private final int buyCost = 750;
	private final int buildCampsiteCost = 1125;
	private final int buildGlampsiteCost = 1500;
	private final int priceToLand = 400;
	private final int priceToLandWithCampsite = 1000;
	private final int priceToLandWithGlampsite = 1250;
	private final String minorDevName = "Meat Alternatives Lab";
	private final String majorDevName = "Energy Efficiency Initiative";
	
	// Constructor
    public SustainabilitySquare(String squareName, int squarePosition) {
        super(squareName, squarePosition);
        this.setFieldName(Field.Sustainability);
        this.owned = false;
