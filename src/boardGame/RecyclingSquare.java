...
public class RecyclingSquare extends StreetSquare{
	
	// Set prices
	private final int buyCost = 100;
	private final int buildCampsiteCost = 150;
	private final int buildGlampsiteCost = 200;
	private final int priceToLand = 50;
	private final int priceToLandWithCampsite = 150;
	private final int priceToLandWithGlampsite = 250;
	private final String minorDevName = "Recycling Plant";
	private final String majorDevName = "Plastic Reuse Research Lab";
	
	// Constructor
    public RecyclingSquare(String squareName, int squarePosition) {
        super(squareName, squarePosition);
        this.setFieldName(Field.Recycling);
        this.owned = false;
